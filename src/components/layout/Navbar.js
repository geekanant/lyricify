...
class Navbar extends Component {
  ...
  componentDidMount() {
    ...
    console.log("%cContact info: anantpatni1@gmail.com", "color: grey; font-size:15px");
  }
        ...
        <Modal isOpen={this.state.modal2} toggle={this.toggle2} className={this.props.className}>
          ...
          <ModalBody>
            ...
            <div className="lead text-center">            
              <a className="btn btn-primary btn-block" href="mailto:anantpatni1@gmail.com" >Contact</a>
            </div>
          </ModalBody>
          <ModalFooter>
