...
async componentDidMount() {
   ...
   await axios.get(`https://cors-anywhere.herokuapp.com/${process.env.REACT_APP_MM_ROOT}track.lyrics.get?track_id=${this.props.match.params.id}&apikey=${process.env.REACT_APP_MM_KEY}
    ...
    //album cover
    await axios.get(`https://ws.audioscrobbler.com/2.0/?method=album.search&album=${this.state.track.album_name}&api_key=24ae15918331f5b8d7fb95c0977a844b&format=json`)
    .then(res => {
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        ...
                                        <br />
                                        This is just some part of the song's lyrics I display for my portfolio.
